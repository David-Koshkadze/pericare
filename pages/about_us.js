...
export default function AboutUs() {
  return (
    <div className="px-4 md:px-0">
      ...
      <p>
        „პერიქეა“ არის პერინატალური ფსიქოლოგიისა და ფსიქოთერაპიის საზოგადოების
        პარტნიორი საქართველოში და საერთაშორისო პროგრამა „Early Life Care”-ის
        პროგრამის ლიცენზიის მფლობელი.
      </p>
      <p>
